package com.example.a21111064571_nguyenvanchuong_kt02.database;
...
public class ProductDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        if (isTableEmpty(db, "tableProduct")) {
            String insert_table_sql = "INSERT INTO tableProduct VALUES (1,'ten1','nha1',12,13),(2,'ten2','nha2',22,23)";
