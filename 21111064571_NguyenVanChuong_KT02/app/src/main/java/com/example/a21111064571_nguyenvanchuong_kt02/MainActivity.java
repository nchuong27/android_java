package com.example.a21111064571_nguyenvanchuong_kt02;
...
import com.example.a21111064571_nguyenvanchuong_kt02.DAO.ProductDao;
import com.example.a21111064571_nguyenvanchuong_kt02.adapter.ProductAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText editTextMaSP, editTextTenSP, editTextSoSP, editTextGiaSP,editTextNhaXB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextNhaXB = findViewById(R.id.edtNhaXB);
    ...
    private void showEditProductDialog(Product productToEdit, int position) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_item_view, null);
        dialogBuilder.setView(dialogView);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final TextView textViewMaSP = dialogView.findViewById(R.id.textViewMaSP);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final EditText editTextTenSP = dialogView.findViewById(R.id.editTextTenSP);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final EditText editTextNhaXB = dialogView.findViewById(R.id.editTextNha);
        ...
        dialogBuilder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                Product editedProduct = new Product(maSP, tenSP,nhaXB, soSP, giaSP);
                ...
                if (updated) {
                    ...
                    Toast.makeText(MainActivity.this, "Sửa tác phẩm thành công", Toast.LENGTH_SHORT).show();
                } else {
