package com.example.a21111064571_nguyenvanchuong_kt02.DAO;
...
import com.example.a21111064571_nguyenvanchuong_kt02.database.ProductDBHelper;
...
public class ProductDao {
    ...
    public long addProduct(Product product){
        ...
        contentValues.put("nhaXB", product.getNhaXB());
    ...
    public boolean updateProduct(Product product) {
        ...
        values.put("nhaXB", product.getNhaXB());
    ...
    public List<Product> getListProduct() {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    if (maSPIndex != -1 && tenSPIndex != -1 && soSPIndex != -1 &&nhaXBIndex != -1 &&
