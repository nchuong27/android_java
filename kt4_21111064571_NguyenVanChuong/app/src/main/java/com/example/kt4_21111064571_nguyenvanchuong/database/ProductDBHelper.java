package com.example.kt4_21111064571_nguyenvanchuong.database;
...
public class ProductDBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_PRODUCT_BIETDANH = "bietdanh";
    public static final String COLUMN_PRODUCT_NGAY = "ngay";
    public static final String COLUMN_PRODUCT_GIO = "gio";
    ...
    private static final String CREATE_TABLE_PRODUCT_DETAIL = "CREATE TABLE " + TABLE_PRODUCT_DETAIL + "(" +
            ...
            COLUMN_PRODUCT_BIETDANH + " TEXT," +
            COLUMN_PRODUCT_NGAY + " DATE," +
            COLUMN_PRODUCT_GIO + " TIME" + "," +
